...
import profileCustomer from "../../../images/profile_customer.png";
...
class CustomerDashboard extends Component {
  constructor(props) {
    super(props);
    const { deliveryAddress } = this.props.auth.user;
    this.state = {
      address: {
  ...
  render() {
    const { firstName, lastName, email, phone } = this.props.auth.user;
    const delivery_address =
      this.state.address.addressline1 +
      "," +
      this.state.address.addressline2 +
        ...
        <div className="row">
          <div className="col s12 m3">
            ...
            <div className="card grey lighten-3">
              <div className="card-content left-align">
                <div
                  className="card-title green-text"
                  style={{ textAlign: "center" }}
                >
                  <h5>Shops available in your district</h5>
                  <img
                    src={onlineShop}
              ...
              <ul className="slides">
                <li>
                  ...
                  <div className="caption left-align text-black">
                    <h2>FOOD</h2>
                    <h5 className="light black-text text-darken-3 hide-on-small-only">
                ...
                <li>
                  ...
                  <div className="caption left-align">
                    ...
                    <h5 className="light white-text text-darken-3 hide-on-small-only">
                      Get your Supplements delivered to your home
                    </h5>
                  </div>
                </li>
                <li>
