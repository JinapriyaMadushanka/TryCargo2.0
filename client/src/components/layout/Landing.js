            ...
            <div className="row">
              <div className="col s12 m4">
                <div className="card">
                  ...
                  <div className="card-content">
                    <span className="card-title center black-text">ORDER</span>
              ...
              <div className="col s12 m4">
                <div className="card">
                  ...
                  <div className="card-content">
                    ...
                    <div className="center">
                      <div>
                        <a className="btn btn-medium amber lighten-2 waves-effect waves-light">
                          <i className="material-icons medium black-text">
                            local_shipping
                          </i>
                        </a>
              ...
              <div className="col s12 m4">
                <div className="card">
                  ...
                  <div className="card-content">
                    <span className="card-title center">PROVIDE</span>
                    <div className="row"></div>
                    <div className="center">
                      <div>
                        <Link
